                ...
                <p class = "dropdown-trigger" onclick="toggleDropdown()">
                    <a href="#where">Where&nbsp;&nbsp;&nbsp;&nbsp;</a>
                        ...
                        <ul id="dropdownContent" class = "dropdown-content">
                            <li><a href = "#"></a> DKI Jakarta</li>
                            <li><a href = "#"></a>Jawa Barat</li>
                            <li><a href = "#"></a>Jawa Tengah</li>
                            <li><a href = "#"></a>Jawa Timur</li>
                            <li><a href = "#"></a>Yogyakarta</li>
                            <li><a href = "#"></a>Bali</li>
                            <li><a href = "#"></a>NTB</li>
                            <li><a href = "#"></a>Sumatera</li>
                            <li><a href = "#"></a>Sulawesi</li>
                            <li><a href = "#"></a>Kalimantan</li>
                            <li><a href = "#"></a>Papua</li>
                        </ul> -->
                
                        <!-- <p class="dropdown-trigger2" onclick="toggleDropdown2()">
                            <button id="whenButton">When&nbsp;&nbsp;&nbsp;&nbsp;</button>
                            <input class="calendarDropdown" type="date" id="calendarInput" style="display: none;">
                          </p> -->

                          <!-- <div id="datepicker-container">
                            <input type="text" id="datepicker" placeholder="">
                            <button id="whenButton" onclick="openDatePicker()" type="button">When&nbsp;&nbsp;&nbsp;&nbsp;</button>
                          </div> -->
                          <!--
                          <div id="datepicker-container">
                            <input type="text" id="datepicker" placeholder="">
...
-->
                ...
                <!-- <ul id="calendarDropdown" class="calendar-dropdown"></ul> -->
                <!--
                <p class = "dropdown-trigger3" onclick="toggleDropdown3()">
                    <a href="#guest">How many Guest</a>
                </p>
                        <ul id="dropdownContent3" class = "dropdown-content3">
                            <li><a href = "#"></a>1</li>
                            <li><a href = "#"></a>2</li>
                            <li><a href = "#"></a>3</li>
                            <li><a href = "#"></a>4</li>
                ...
                <div>
                    <button class="search" type="submit">
                        <img class="search-button" src="img/search-button2.png" alt="Search">
                    </button>
                </div>
                                ...
                                <div class="button-craft" >
                                    ...
                                    <div class= "label" > 
                                        <div class = "label-pottery">
                                            ...
                                            <div class="desc">
                                                <p>
                                                    <span style="" class="left-content"><?php echo $get_all_workshops_workshop_date;?><br>Rp <?php echo $get_all_workshops_workshop_price;?></span>
